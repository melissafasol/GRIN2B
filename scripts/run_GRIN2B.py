...
for animal in br_animal_IDs:
        ...
        for channelnumber in channel_number_list:
            ...
            os.chdir('/home/melissa/PREPROCESSING/GRIN2B/filtered_data/NREM')
            np.save('filter_1_' + str(animal) + '_' + str(channelnumber) + '_' + str(brain_state_number) + '.npy', filtered_data_1, allow_pickle=True)
            np.save('filter_2_' + str(animal) + '_' + str(channelnumber) + '_' + str(brain_state_number) + '.npy', filtered_data_2, allow_pickle = True)
